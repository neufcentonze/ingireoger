function computeUniversalGain(baseProbability, streak = 1, houseEdge = 0.10) {
...
function computeMinesStreakGain(safeCount, totalCells, streak, houseEdge = 0.10) {
  let probability = 1;
...
module.exports = {
  computeUniversalGain,
  computeMinesStreakGain
};
